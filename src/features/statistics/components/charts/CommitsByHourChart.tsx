...
/**
 * Commits by hour of day - bar chart
 */
export function CommitsByHourChart({ hourBuckets }: CommitsByHourChartProps) {
  const data = useMemo(() => distributionToUPlotData(hourBuckets), [hourBuckets]);
      ...
      axes: [
        {
          ...
          values: (u, vals) => vals.map((v) => {
            ...
            // Show only every 4 hours for cleaner labels
            if (hour % 4 === 0) {
